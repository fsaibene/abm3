...
public class InsertActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras!=null){
            String etiquetaE = extras.getString("ETIQUETA");
            String fechaE = extras.getString("FECHA");
            String montoE = extras.getString("MONTO");

            this.monto.setText(montoE);
            this.fecha.setText(fechaE);
